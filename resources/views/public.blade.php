...
@section('container')
    ...
    <div
      id="banner-page"
      class="banner-page"
      style="background-image: url(img/pendaftaran-publik.webp)"
    >
          ...
          <div class="row">
            <div class="col-lg-12 inner">
              <div class="page-heading">
                <h1 class="page-title">Public Training</h1>
              </div>
            </div>
          </div>
        </div>
...
@section('myjsfile')
    <script>
        ...
        name.addEventListener('change', function() {
            fetch('/public-training/checkSlug?name=' + name.value)
