...
@section('container')
    ...
    <div class="inhouse-section section-padding px-3 py-2 bg-white rounded">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                  <i class="fa-solid fa-pencil me-1"></i> Edit Pendaftar inhouse Training
                </li>
              </ol>
            </nav>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <form method="post" action="/dashboard/inhouse/{{ $inhouse->slug }}" class="mb-5" enctype="multipart/form-data">
                @method("put")
                @csrf
                <div class="pt-2 pb-2 mb-2 subtitle">
                  ...
                  <div class="mb-3">
                    ...
                    <input readonly
                      ...
                      name="program"
                      required=""
                      value="{{ old('program', $inhouse->program) }}"
                    />
                    @error('program')
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2 disable">
                    <div class="total_of_participants w-100 mb-2 mb-md-0">
                      ...
                      <input readonly
                        ...
                        required=""
                        value="{{ old('total_of_participants', $inhouse->total_of_participants) }}"
                      />
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2 disable">
                    <div class="name_of_participants w-100 mb-2 mb-md-0">
                      ...
                      >
                      <textarea readonly class="form-control" id="name_of_participants" type="hidden" name="name_of_participants" style="height: 150px">{{ old('name_of_participants', $inhouse->name_of_participants) }}</textarea>
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2">
                    ...
                    <div class="job_position w-100">
                      ...
                      <input readonly
                        ...
                        name="job_position"
                        required=""
                        value="{{ old('job_position', $inhouse->job_position) }}"
                      />
                      @error('job_position')
                        <div class="invalid-feedback">
                            {{ $message }}
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2">
                    <div class="company w-100">
                      ...
                      <input readonly
                        ...
                        id="company"
                        name="company"
                        value="{{ old('company', $inhouse->company) }}"
                      />
                      @error('company')
                        <div class="invalid-feedback">
                            {{ $message }}
                  ...
                  <div class="mb-2">
                    ...
                    >
                    <textarea readonly class="form-control" id="company_address" type="hidden" name="company_address" style="height: 150px">{{ old('company_address', $inhouse->company_address) }}</textarea>
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2">
                    <div class="company_mail w-100 mb-2 mb-md-0">
                      ...
                      <input readonly
                        ...
                        name="company_email"
                        required=""
                        value="{{ old('company_email', $inhouse->company_email) }}"
                      />
                      @error('company_email')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="email w-100 mb-2 mb-md-0">
                      ...
                      <input readonly
                        ...
                        required=""
                        value="{{ old('alternative_email', $inhouse->alternative_email) }}"
                      />
                  ...
                  <div class="d-md-flex pt-2 pb-2 mb-2">
                    <div class="company_phone w-100">
                      ...
                      <input readonly
                        ...
                        name="company_phone"
                        required=""
                        value="{{ old('company_phone', $inhouse->company_phone) }}"
                      />
                      @error('company_phone')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="handphone w-100">
                      ...
                      <input readonly
                        ...
                        name="handphone"
                        required=""
                        value="{{ old('handphone', $inhouse->handphone) }}"
                      />
                      @error('handphone')
                        <div class="invalid-feedback">
                            {{ $message }}
