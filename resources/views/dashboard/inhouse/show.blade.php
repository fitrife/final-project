              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">
                    <i class="fa-solid fa-eye me-1"></i> Lihat inhouse
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
              <div class="message-data border-0 mb-0 pb-0">
                ...
                <div class="mb-3">
                  ...
                  >
                  <p>
                    <i class="fa-solid fa-caret-right ms-2 me-2"></i>{{ $inhouse->program }}
                  </p>
                </div>
                <div class="mb-3">
                  <label for="total-of-participan" class="form-label mb-0"
                    >Jumah Peserta</label
                  >
                  <p><i class="fa-solid fa-caret-right ms-2 me-2"></i>{{ $inhouse->total_of_participants }}</p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i> {{ $inhouse->name }}
                  </p>
                </div>
                <div class="mb-3">
                  ...
                  >
                  <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i> {{ $inhouse->job_position }}
                  </p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  >
                  <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i> {{ $inhouse->company_phone }}
                  </p>
                </div>
                <div class="mb-3">
                  ...
                  >
                  <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i> {{ $inhouse->handphone }}
                  </p>
                </div>
                <div class="mb-3">
