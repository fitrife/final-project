    ...
    <div class="schedule-section section-padding px-3 py-2 bg-white rounded">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input type="schedule" name="schedule" class="form-control @error('schedule')is-invalid @enderror" id="schedule" required autofocus value="{{ old('schedule') }}">
                @error('schedule')
            ...
            <div class="mb-3">
                ...
                <input type="method" name="method" class="form-control @error('method')is-invalid @enderror" required autofocus value="{{ old('method') }}">
                @error('method')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="method" class="form-control" placeholder="Metode Training">
                </div>
            </div> 
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Taggal Pelaksanaan:</strong>
                    <input type="text" name="schedule" class="form-control" placeholder="Tanggal">
                </div>
            </div>  
