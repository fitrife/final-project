        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <div class="mb-3">
                    ...
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->name }}
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->birthdate }}
                    </p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{  $kemnaker->phone  }}
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{  $kemnaker->education->name  }}
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->job }}
                    </p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>
                    @if($kemnaker->company_address == NULL)
                        -
                    @else
                        {!! $kemnaker->company_address !!}
                    @endif
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->company_messenger }}
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->have_attended_training }}
                    </p>
                </div>
                <div class="mb-3">
                    <label for="program" class="form-label mb-0"
                    >Program Sertifikasi Kemnaker RI yang dipilih</label
                    >
                    <p>
                    <i class="fa-solid fa-caret-right ms-2 me-2"></i>{{ $kemnaker->training?->name }}
                    </p>
                </div>
                <div class="mb-3">
                    ...
                    >
                    <p class="ms-2">
                    <i class="fa-solid fa-caret-right me-2"></i>{{ $kemnaker->progress }}
                    </p>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-0">
                    <a
                        href="/dashboard/kemnaker"
                        class="btn btn-success m-auto"
                    >
                        <i class="fa-solid fa-arrow-left me-1"></i> Kembali
                    </a>
                    <a
                    href="/dashboard/kemnaker/{{ $kemnaker->slugKemnaker }}/edit"
