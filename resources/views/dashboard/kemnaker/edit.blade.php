        ...
        <div class="col-md-12">
          <div class="form-registration w-100">
            <div class="form-registration w-100">
              <form
                method="post"
                action="/dashboard/kemnaker/{{ $kemnaker->slugKemnaker }}"
                class="mb-2"
                ...
                <div class="mb-3">
                    ...
                    <select disabled class="form-select" name="training_id">
                        @foreach ($training as $training)
                            <option value="{{ $training->id }}" {{ old('training_id', $kemnaker->training_id) == $training->id ? 'selected' : null }}>{{ $training->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-2">
